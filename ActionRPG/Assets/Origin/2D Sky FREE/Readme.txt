...
------------------------------------------------------------------
	...
	It is easy to use, just copy sky from the demo scene and paste on your scene.
	...
	Note:
		...
		• If you are interested or need them, please visit 2D Sky full version. See below urls.

	Product page:
	
		Unity Asset Store:	https://www.assetstore.unity3d.com/en/#!/content/21555
		GE Store:		http://www.ge-team.com/store/en/products/2d-sky-free/

	Full Version:	
	
		Unity Asset Store:	https://www.assetstore.unity3d.com/en/#!/content/58833
		GE Store:		http://www.ge-team.com/store/en/products/2d-sky/
